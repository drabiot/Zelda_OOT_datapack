...
execute store result score $out player_motion.internal.motion.x run data get storage player_motion:math motion[0] 3000
execute store result score $out player_motion.internal.motion.z run data get storage player_motion:math motion[2] 3000
...
scoreboard players set @s player_motion.internal.motion.y 1200
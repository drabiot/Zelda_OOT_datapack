...
execute store result score $out player_motion.internal.motion.x run data get storage player_motion:math motion[0] 5000
execute store result score $out player_motion.internal.motion.z run data get storage player_motion:math motion[2] 5000
...
scoreboard players set @s player_motion.internal.motion.y 7000
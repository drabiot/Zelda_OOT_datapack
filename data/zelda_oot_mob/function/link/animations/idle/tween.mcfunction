...
tag @s add zelda_oot_mob.link.animation.idle.playing
...
execute at @s run function zelda_oot_mob:link/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function zelda_oot_mob:link/animations/idle/zzz/apply_frame {frame: $(to_frame)}

...
function zelda_oot_mob:kokiri_shopkeeper/animations/pause_all
tag @s add zelda_oot_mob.kokiri_shopkeeper.animation.idle.playing
...
execute at @s run function zelda_oot_mob:kokiri_shopkeeper/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function zelda_oot_mob:kokiri_shopkeeper/animations/idle/zzz/apply_frame {frame: $(to_frame)}

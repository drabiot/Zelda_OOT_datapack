...
function zelda_oot_mob:fado/animations/pause_all
tag @s add zelda_oot_mob.fado.animation.idle.playing
...
execute at @s run function zelda_oot_mob:fado/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function zelda_oot_mob:fado/animations/idle/zzz/apply_frame {frame: $(to_frame)}

...
data modify entity @e[type=block_display,limit=1] transformation.translation set value [-0.5f,0.0f,-0.5f]
data modify entity @e[type=block_display,limit=1] interpolation_duration set value 60

execute if entity @a[tag=trial_kokiri] run schedule function zelda_oot:game/kokiri_forest/loader/trial/left 70t
...
execute as @e[type=item_display,tag=know_it_all_brother_sitting_1_display] run function zelda_oot_mob:know_it_all_brother/remove/this
...
execute as @e[type=item_display,tag=know_it_all_brother_sitting_2_display] run function zelda_oot_mob:know_it_all_brother/remove/this
...
execute as @e[type=item_display,tag=know_it_all_brother_standing_display] run function zelda_oot_mob:know_it_all_brother/remove/this

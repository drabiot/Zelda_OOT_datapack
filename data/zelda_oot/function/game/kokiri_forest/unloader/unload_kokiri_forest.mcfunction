...
#Remove Green Rupees
execute positioned -418 4.5 -29 run kill @e[type=item_display,name=rupees,tag=green,distance=..5]
execute positioned -439 4.5 -7 run kill @e[type=item_display,name=rupees,tag=green,distance=..5]

...
execute positioned -461 10 3 if entity @p[distance=..1.5] run function zelda_oot:game/kokiri_forest/wrapper/kia_brother/kia_brother_kokiri
...
execute positioned -463 -4 3 if entity @p[distance=..0.5] run function zelda_oot:game/kokiri_forest/wrapper/kia_brother/kokiri_kia_brother

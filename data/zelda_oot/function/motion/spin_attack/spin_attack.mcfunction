...
#Breakable damage
execute as @a[tag=in_spin_attack,tag=!spinning] at @s store success score @s spin_shatter run fill ~-1 ~0 ~-1 ~1 ~0 ~1 minecraft:air replace minecraft:bush
...
execute as @a[tag=in_spin_attack,tag=!spinning] at @s store success score @s spin_shatter run fill ~-1 ~0 ~-1 ~1 ~0 ~1 minecraft:air replace minecraft:spruce_sign
...
execute as @a[tag=in_spin_attack,tag=!spinning] at @s store success score @s spin_shatter run fill ~-1 ~0 ~-1 ~1 ~0 ~1 minecraft:air replace minecraft:firefly_bush
execute as @a[tag=in_spin_attack,tag=!spinning] at @s if score @s spin_shatter matches 1 run playsound minecraft:block.sweet_berry_bush.break player @a ~ ~ ~ 1 1

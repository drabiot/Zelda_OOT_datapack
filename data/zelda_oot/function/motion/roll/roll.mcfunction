...
execute as @a[tag=roll_press,predicate=!zelda_oot:movement/tight,predicate=!zelda_oot:movement/jump,predicate=zelda_oot:movement/forward,tag=!forward_held_roll,tag=!in_roll,tag=!in_backflip,tag=!in_sidestep_left,tag=!in_sidestep_right,tag=!dev,tag=!is_swimming,tag=!dialogue,tag=!playing_ocarina,tag=!sneak_pressed_now_roll] run tag @s add sneak_pressed_now_roll
execute as @a[tag=roll_press,predicate=!zelda_oot:movement/tight,predicate=!zelda_oot:movement/jump,predicate=zelda_oot:movement/forward,tag=!in_roll,tag=!in_backflip,tag=!in_sidestep_left,tag=!in_sidestep_right,tag=!dev,tag=!is_swimming,tag=!dialogue,tag=!playing_ocarina,tag=!forward_held_roll] run tag @s add forward_held_roll

...
function zelda_oot:npc_model/fado/animations/pause_all
tag @s add zelda_oot.npc_model.fado.animation.idle.playing
...
execute at @s run function zelda_oot:npc_model/fado/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function zelda_oot:npc_model/fado/animations/idle/zzz/apply_frame {frame: $(to_frame)}

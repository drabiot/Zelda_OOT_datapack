...
data modify storage animated_java:temp entry.data.blueprint_id set value "zelda_oot:twins"
data modify storage animated_java:temp entry.data.rig_hash set value "926453845a1b3f377b68e7b40b5caff7b1a1e1b9a0cd38cf69dd8460c7dc8486"
tp @s ~ ~ ~ ~ ~
execute on passengers if entity @s[tag=zelda_oot.twins.node.head] run function zelda_oot:twins/zzz/summon/as_node/head
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.head set from storage animated_java:gu out
execute on passengers if entity @s[tag=zelda_oot.twins.node.body] run function zelda_oot:twins/zzz/summon/as_node/body
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.body set from storage animated_java:gu out
execute on passengers if entity @s[tag=zelda_oot.twins.node.left_arm] run function zelda_oot:twins/zzz/summon/as_node/left_arm
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.left_arm set from storage animated_java:gu out
execute on passengers if entity @s[tag=zelda_oot.twins.node.right_arm] run function zelda_oot:twins/zzz/summon/as_node/right_arm
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.right_arm set from storage animated_java:gu out
execute on passengers if entity @s[tag=zelda_oot.twins.node.left_leg] run function zelda_oot:twins/zzz/summon/as_node/left_leg
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.left_leg set from storage animated_java:gu out
execute on passengers if entity @s[tag=zelda_oot.twins.node.right_leg] run function zelda_oot:twins/zzz/summon/as_node/right_leg
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
...
function zelda_oot:twins/zzz/set_default_pose
execute if data storage animated_java:temp args.variant run function zelda_oot:twins/zzz/summon/variant_arg/process with storage animated_java:temp args
execute if score #success aj.i matches 0 run return fail
execute if data storage animated_java:temp args.animation run function zelda_oot:twins/zzz/summon/animation_arg/process with storage animated_java:temp args
execute if score #success aj.i matches 0 run return fail

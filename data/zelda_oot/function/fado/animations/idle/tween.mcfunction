...
function zelda_oot:fado/animations/pause_all
tag @s add zelda_oot.fado.animation.idle.playing
...
execute at @s run function zelda_oot:fado/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function zelda_oot:fado/animations/idle/zzz/apply_frame {frame: $(to_frame)}

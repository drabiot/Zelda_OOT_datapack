...
tag @s add zelda_oot.link.animation.idle.playing
...
execute at @s run function zelda_oot:link/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function zelda_oot:link/animations/idle/zzz/apply_frame {frame: $(to_frame)}
